...
const validateUser = [
  ...
  body("rolebrand").notEmpty().withMessage(ErrorMessageBase.format(ErrorMessageBase.NotEmpity, { PropertyName: "rolebrand"})),
  body("province").notEmpty().withMessage(ErrorMessageBase.format(ErrorMessageBase.NotEmpity, { PropertyName: "province"})),
  async(req, res, next) => {
